...
export default function FilterComponent() {
    ...
    switch (filterInput) {
      case 'string':
        return (
          <div>
            <>
              <InputText value={filterValue} onChange={(e) => setFilterValue(e.target.value)} placeholder="Search" />
              <Dropdown
                value={sorting}
                options={sortOptions}
  ...
  return (
    <div className="card flex justify-content-center attributes">
      <SelectButton value={selectedFilter} onChange={onFilterChange} optionLabel="label" options={filterItems} />
      {renderFilterInput()}
    </div>
  );
}
